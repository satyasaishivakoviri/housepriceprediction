...
const buttonVariants = cva(
    "relative group border text-foreground mx-auto text-center rounded-full inline-flex items-center justify-center",
    {
        variants: {
            variant: {
                default: "bg-blue-500/5 hover:bg-blue-500/0 border-blue-500/20 text-white", // Adjusted for dark theme default
                ...
                primary: "bg-primary/5 hover:bg-primary/0 border-primary/20 text-white", // Added Primary (Gold/Red) variant
                primarySolid: "bg-primary hover:bg-red-700 text-white border-transparent hover:border-white/20 transition-all duration-200", // Added Primary Solid
            },
            size: {
                default: "px-7 py-3 ", // Increased py for better touch targets
                sm: "px-4 py-1 ",
                lg: "px-10 py-4 ",
            },
        },
