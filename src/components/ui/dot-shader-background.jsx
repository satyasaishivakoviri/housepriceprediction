...
// Extend Three.js with the customized shader material
...
function Scene() {
    ...
    // Debug log
    useEffect(() => {
        console.log("DotShaderBackground Mounted. Theme:", theme);
    }, [theme]);
